...
import br.com.bfmapper.DefaultTransformer;
...
public class ProdutoMappingRules implements RulesMapper {
	...
	public void loadRules() {
		MappingRules.addRule(new Converter(ProdutoCanonico.class, Produto.class, new DefaultTransformer(String.class, String.class, new UpperCaseTransformer()), new DefaultTransformer(Double.class, Float.class, new NumberTransformer())) {{
